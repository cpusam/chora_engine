...
{
	if (a->getVelocity().isZero() || b->getVelocity().isZero())
	...
	if ((a->getVelocityY() > 0 || b->getVelocityY() < 0) && lineIntersects(a1, a2, b1, b2, result))
		return RectSide::TOP;
	...
	if ((a->getVelocityX() > 0 || b->getVelocityX() < 0) && lineIntersects(a1, a2, b1, b2, result))
