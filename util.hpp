...
extern void fill_rect ( CCamera * cam, SDL_Renderer * renderer, SDL_Color color, SDL_Rect r );

extern int draw_texture ( SDL_Texture * texture, int x, int y, CCamera * cam, SDL_Renderer * renderer );
